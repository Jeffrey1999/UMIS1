...
mysqli_query($link,"insert into tbl_complaintuser values('','$_POST[txtname]','$_POST[txtcontact]','$_POST[txtbuilding]','$_POST[txtcomplaint]',
            ...
            <form action="" method="post" name="formProduct">
              <div class="row">
                ...
                <div class="form-group">
                  ...
                  <input value="<?php echo $_SESSION['username'];?>" class="form-control" name="txtname"  placeholder="Enter Name"required>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="txtcontact"  placeholder="Enter contact"required>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" class="form-control" name="txtstatus" id="txtstatus"  value="Not Approved" required>
...
<div class="form-group">
                  ...
                  <textarea type="text" class="form-control" name="txtcomments" rows="8" placeholder="specify complaint here.."></textarea>
                </div>
              ...
              <button type="submit" value="Submit" class="btn btn-success" name="btnsubmit">Submit Complaint</button>
                </div>
