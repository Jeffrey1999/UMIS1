...
<div class="row">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="txtintroduction"  placeholder="Introduction of Inspection"required>
                </div>
              ...
              <button type="submit" class="btn btn-info"name="btnaddasset">Add an asset</button>
                </div>
            </form>
          </div><!-- /.card-body -->
        </div>
