          ...
          <table id="assettable" class="table  table-bordered " >
                  ...
                  <tbody>
                      ...
                      while ($row=$select->fetch(PDO::FETCH_OBJ)){
                          ...
                          <span class="fas fa-eye" style="color:#ffffff" data-toggle="tooltip" title="View ">
                          </span>  </button>
                          
                          <button id='.$row->id.' class="btn btn-danger btndelete">
                          <span class="fas fa-trash-alt" style="color:#ffffff" data-toggle="tooltip" title="delete">
                          </span>  </button>
                          </td>
  ...
  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <?php  
                        ...
                        $select_name = "SELECT * FROM tbl_complaintuser";
                        $run_name  = mysqli_query($con, $select_name);
                        while($row_name = mysqli_fetch_array($run_name))
                        {
                            $cname  = $row_name['name'];
                            $txtc  = $row_name['contact'];
                            $txtb  = $row_name['building'];
                            $type  = $row_name['typeofcomplaint'];
                            $txtlocation = $row_name['location'];
                            $usrStatus   = $row_name['status'];
                            $comment     = $row_name['comments'];
              ...
              <div class="row">
                ...
                <div class="form-group col-6 col-md-6"> 
                  ...
                  <input class="form-control" value="<?php echo $cname; ?>" name="txtname" id="txtname" placeholder="Enter Name">
                </div>

                <div class="form-group">
                  <label> Contact</label>
                  <input type="hidden" value="<?php echo $id; ?>" class="form-control" name="id"  placeholder="Enter Name"required>
                  <input type="text" value="<?php echo $txtc; ?>" class="form-control" name="txtcontact" id="txtcontact"  placeholder="Enter Name">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" value="<?php echo $id; ?>" class="form-control" name="id"  placeholder="Enter Name"required>
                  <input type="text" class="form-control" value="<?php echo $txtb; ?>"  name="txtbuilding" id="txtbuilding"  placeholder="Enter Name">
                </div>
                
                <div class="form-group">
                  <label>Type of Complaint</label>
                  <input type="hidden" value="<?php echo $id; ?>" class="form-control" name="id"  placeholder="Enter Name"required>
                  <input type="text" class="form-control" value="<?php echo $type; ?>" name="txttypeofcomplaint" id="txttypeofcomplaint"  placeholder="Enter Name">
                </div>

                <div class="form-group">
                  <label>Location</label>
                  <input type="hidden" value="<?php echo $id; ?>" class="form-control" name="id"  placeholder="Enter Name"required>
                  <input type="text" class="form-control" value="<?php echo $txtlocation; ?>" name="txtlocation" id="txtlocation" placeholder="Enter Name">
                </div>
                ...
                <div class="form-group">
                  ...
                  <option value="<?php echo $usrStatus; ?>"><?php echo $usrStatus; ?></option>
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" value="<?php echo $id; ?>" class="form-control" name="id"  placeholder="Enter Name"required>
                  <textarea type="text" class="form-control" name="txtcomments" id="txtcomments" rows="3" placeholder="specify complaint here..">
                   <?php echo $comment; ?>
                  </textarea>
                </div>              
              </div>
