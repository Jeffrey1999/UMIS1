...
if (isset($_POST['btnaddcomplaint'])){
      ...
      <div class="row">
        ...
        <div class="card card-warning card-outline">
          ...
          <div class="card-body">
            ...
            <form name="complaintform" action="" method="POST" >
<div class="row">
              ...
              <button type="submit" class="btn btn-danger" name="btnaddcomplaint">Make a Complain</button>
                </div>
            </form>
